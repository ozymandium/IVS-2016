...
text(2.5, 1, 'j_p^+', 'Color', 'c', 'FontSize', 16, 'VerticalAlignment', 'top', 'FontWeight', 'bold')
plot([0 2.5], [1.5 1.5], '--r', 'linewidth', 3)
text(2.5, 1.5, 'j_m^+', 'Color', 'r', 'FontSize', 16, 'VerticalAlignment', 'top', 'FontWeight', 'bold')
plot([0 2.5], [-1 -1], '--c', 'linewidth', 3)
text(2.5, -1, ' -j_p^+', 'Color', 'c', 'FontSize', 16, 'VerticalAlignment', 'bottom', 'FontWeight', 'bold')
plot([0 2.5], [-1.5 -1.5], '--r', 'linewidth', 3)
text(2.5, -1.5, '-j_m^+', 'Color', 'r', 'FontSize', 16, 'VerticalAlignment', 'bottom', 'FontWeight', 'bold')
plot([4 8], [-1.5, -1.5], '--r', 'linewidth', 3)
text(4, -1.5, 'j_m^- ', 'Color', 'r', 'FontSize', 16, 'VerticalAlignment', 'bottom', 'FontWeight', 'bold', 'HorizontalAlignment', 'right')
plot([4 8], [-1 -1], '--c', 'linewidth', 3)
text(4, -1, 'j_p^- ', 'Color', 'c', 'FontSize', 16, 'VerticalAlignment', 'bottom', 'FontWeight', 'bold', 'HorizontalAlignment', 'right')
plot([4 8], [1.5, 1.5], '--r', 'linewidth', 3)
text(4, 1.5, '-j_m^- ', 'Color', 'r', 'FontSize', 16, 'VerticalAlignment', 'top', 'FontWeight', 'bold', 'HorizontalAlignment', 'right')
plot([4 8], [1 1], '--c', 'linewidth', 3)
text(4, 1, '-j_p^- ', 'Color', 'c', 'FontSize', 16, 'VerticalAlignment', 'top', 'FontWeight', 'bold', 'HorizontalAlignment', 'right')
