...
\begin{figure}[thpb]
\centering
  \subfigure[Normal mode]{\includegraphics[width=1.0\columnwidth]{graphics/RSTOP_NORMAL.png}}
\\
  \subfigure[Stopping for the pedestrian]{\includegraphics[width=1.0\columnwidth]{graphics/RSTOP_RSTOP.png}}
\\
