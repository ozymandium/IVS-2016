...
It will be shown how two dimensional concerns (specifically cornering speeds for this work) may be expressed in one dimension to guide planning.
All planning will be longitidinal; that is, speed will be the primary focus, and it is assumed that a separate yaw controller will ensure that the origin of the vehicle.
