...
The second task is velocity planning (or trajectory generation) which involves the computation of the fastest velocity profile that is appropriate for the cargo or passengers.
