...
In the consolidation step, a single $\bf{g}$ must be calculated for each segment using the values of $\bf{g}$ corresponding to each of the path points which comprise the segment in question.
