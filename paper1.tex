...
To set boundary speed conditions for the interior segments, 
...
\begin{figure}
  \begin{algorithmic}[1]
    \Procedure{SegmentBoundarySpeeds}{$v_m$}
      ...
      \State 
      \State $\mathbf{v}_p = [\mathbf{v}_p, 0]$ \Comment{Final speed is 0}
      \For{$k = 1, ..., N_s-2$}
      \EndFor
    \EndProcedure
  \end{algorithmic}
\caption{Algorithm to set speed boundary conditions for interior path segments}
\label{fig:segmentspeedboundaryconditions}
\end{figure}
