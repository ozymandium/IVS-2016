...
Section \ref{sec:trajectoryplanning} describe trajectory planning, where we start with a 2D path, and generate a trajectory that satisfies maximum velocity, acceleration and jerk constraints. 
