...
\begin{figure}[tb]
\centering
  \subfigure[In NORMAL mode, RSTOP is now triggered.]{\includegraphics[width=0.8\columnwidth]{graphics/RSTOP_NORMAL_time_to_stop.png}}
  \\
  \subfigure[RSTOP diagram showing bounds for revising the RSTOP trajectory.]{\includegraphics[width=0.9\columnwidth]{graphics/RSTOP_Replan.png}}
  \\
