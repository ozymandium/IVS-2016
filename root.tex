...
Within the trajectory tracker, all portions of the path leading up to the location of RSTOP tiggering are removed, as well as the portions after the location which corresponds to $s_{veh} + \Delta s_{RSTOP}$
