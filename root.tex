...
{\it Path Planning} involves computation of the optimal path and {\it Trajectory Planning} involves the computation of a time-parameterized velocity profile appropriate for the scenario.
...
We present a deterministic autonomy framework for pedestrian-aware ground vehicles with a novel method for planning longitudinal trajectories 
